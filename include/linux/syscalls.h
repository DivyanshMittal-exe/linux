...
asmlinkage long sys_register_rm( pid_t pid,unsigned int period,unsigned int  deadline,unsigned int  exec_time);
asmlinkage long sys_register_dm( pid_t pid,unsigned int  period,unsigned int  deadline,unsigned int  exec_time);
asmlinkage long sys_yield(pid_t pid);
asmlinkage long sys_remove(pid_t pid);
asmlinkage long sys_list(void);
